...
2. **Create a Summary:** Provide a detailed summary of the change. Your summary MUST begin with a high-level description of the project itself
     ...
     Imagine that you write a detailed commit message for the diff if it didn't have one.
3. **List changed symbols**. Provide a list of functions, methods, classes changed by this change.
